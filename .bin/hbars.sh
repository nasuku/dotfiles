...
#
# source from https://funprojects.blog/2021/05/14/bash-bar-charts-for-text-and-web-pages/
width=50
title=""
color=7
pretty=False
...
usage() {
  echo "usage: hbars.sh [data] [option] "
  ...
  echo ""
  echo " examples:"
  echo "   echo 'temp,33,C;pressure,14,psi' | ./hbars.sh -t Weather -p -w 40 "
  echo "   ./hbars.sh -t Weather -p -w 40  'temp,33;pressure,14' "
  echo "   cat data.txt | ./hbars.sh -W -f 24 -t 'Raspi Data' > data.htm"
  echo ""
